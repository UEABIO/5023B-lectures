...
```{r, echo = FALSE, out.width="100%", fig.alt = "R project organisation"}
...
```{r, echo = FALSE, out.width="80%", fig.alt = "Allison Horst"}
...
- Mean imputation can introduce bias if data is not missing at random.

- Reduces variability in the dataset.

- More sophisticated methods include median imputation, regression imputation, and multiple imputation.
...
$$
    \log{\lambda} = \beta_0 + \beta_1 T_i + \beta_2 T_j + \beta_2 T_k 
$$
