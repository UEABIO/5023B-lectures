...
$$
\LARGE(log)\lambda=\beta0+\beta1x
$$

$$
\LARGE Y\text{~}~Pois(\lambda)
$$
...
$$
\LARGE logit(p)=log({p\over1-p})=\beta0+\beta1x
$$

Exponentiated:

$$
\LARGE p={e^{\beta0+\beta1x}\over{1+e^{\beta0+\beta1x}}}
$$
...
knitr::include_graphics("images/binned.png")
